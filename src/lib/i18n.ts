...
const messages = {
  en: {
    ...
    update: {
      ...
      versions: "You are on {current}. Version {next} is available.",
      notes: "What's new",
      noNotes: "This release came without notes.",
      install: "Install and restart",
      viewRelease: "View release on GitHub",
      later: "Not now",
      installing: "Downloading and installing… the app restarts on its own.",
      failed: "The update could not be installed: {error}",
    },
    sidePanel: {
      tabRename: "Rename",
    ...
    batch: {
      ...
      select: {
        ...
        addFiles: "Add files…",
        sourceFolder: "Folder",
        sourceFolderNone: "No folder — files added one by one",
        sourceFolderExtra: "and {count} more",
        changeFolder: "Change folder",
        chooseFolder: "Choose folder",
        includeSubfolders: "Include subfolders",
        includeSubfoldersHint: "Re-scans the folders added here. Files added one by one are kept.",
      ...
      settings: {
        ...
        hardwareResolved: "This job will use {backend}. GPU errors fall back to CPU safely.",
        hardwareUnavailable: "unavailable",
        hardwareUnavailableHint: "This encoder cannot be used for the selected codec on this computer.",
        hardwareNoneAvailable: "No GPU encoder is usable here, so this job runs on the CPU.",
        backendSoftware: "CPU (software)",
        backendNvidia: "NVIDIA NVENC",
        backendIntel: "Intel Quick Sync",
        backendAmd: "AMD AMF",
        backendVideoToolbox: "Apple VideoToolbox",
        backendVaapi: "Linux VAAPI",
        crf: "Quality (CRF {value})",
        crfHint: "Lower is better quality and a bigger file. 23 (H.264) / 28 (H.265) are good defaults.",
        hardwareQuality: "Hardware quality ({value})",
        hardwareQualityHint: "Lower is better quality and a bigger file. The value is mapped to the selected GPU encoder.",
      ...
      estimate: {
        action: "Estimate output size",
        running: "Encoding samples…",
        title: "Estimated converted size",
        samples: "{sampled} of {total} files sampled",
        failed: "{count} samples could not be measured; their original size is used.",
      },
      run: {
  ...
  es: {
    ...
    update: {
      ...
      versions: "Tienes la {current}. La {next} ya está disponible.",
      notes: "Novedades",
      noNotes: "Esta versión se publicó sin notas.",
      install: "Instalar y reiniciar",
      viewRelease: "Ver la release en GitHub",
      later: "Ahora no",
      installing: "Descargando e instalando… la app se reinicia sola.",
      failed: "No se ha podido instalar la actualización: {error}",
    },
    sidePanel: {
      tabRename: "Renombrar",
    ...
    batch: {
      ...
      select: {
        ...
        sourceFolderNone: "Sin carpeta: archivos añadidos uno a uno",
        sourceFolderExtra: "y {count} más",
        changeFolder: "Cambiar carpeta",
        chooseFolder: "Elegir carpeta",
        includeSubfolders: "Incluir subcarpetas",
        includeSubfoldersHint: "Vuelve a escanear las carpetas añadidas aquí. Los archivos añadidos uno a uno se conservan.",
      ...
      settings: {
        ...
        hardware: "Codificador de vídeo",
        hardwareAuto: "Automático (recomendado)",
        hardwareResolved: "Este trabajo usará {backend}. Si falla la GPU, se reintentará de forma segura con CPU.",
        hardwareUnavailable: "no disponible",
        hardwareUnavailableHint: "Este codificador no se puede usar con el códec elegido en este equipo.",
        hardwareNoneAvailable: "Ningún codificador de GPU es utilizable aquí, así que este trabajo usará la CPU.",
        backendSoftware: "CPU (software)",
        backendNvidia: "NVIDIA NVENC",
        backendIntel: "Intel Quick Sync",
        backendAmd: "AMD AMF",
        ...
        hardwareQuality: "Calidad por hardware ({value})",
        hardwareQualityHint: "Un valor menor da más calidad y ocupa más. Se adapta al codificador de la GPU elegida.",
      ...
      estimate: {
        action: "Estimar tamaño de salida",
        running: "Codificando muestras…",
        title: "Tamaño convertido estimado",
        samples: "muestra de {sampled} de {total} archivos",
        failed: "No se pudieron medir {count} muestras; se usa su tamaño original.",
      },
      run: {
        ...
        fallbackUsed: "se usó alternativa",
